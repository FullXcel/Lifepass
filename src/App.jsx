          ...
          <Section title="내 정보 불러오기" subtitle="문서나 상담 메모에서 나이, 거주지역, 소득, 월세처럼 판정에 필요한 정보를 읽어옵니다.">
            <div className="two-col">
              ...
              <div className="info-box">
                <p>내 정보 불러오기 탭은 사용자가 자신의 나이, 거주 지역, 소득, 월세, 보증금, 고용 상태, 실업급여 잔여기간, 준비 가능한 서류 등 복지 혜택 판정에 필요한 기본 정보를 플랫폼에 입력하는 첫 단계로, 사용자는 상담 메모, 임대차계약 관련 문서, 소득·주거 상황이 적힌 텍스트 파일 등을 업로드하여 자신의 상황을 자동으로 정리할 수 있습니다.</p>
